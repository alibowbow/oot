...
### 🎓 배우기 — 오카리나 음악 교실 (Learn)
- **음악 교과서처럼 배우는 6단원 커리큘럼**: 악기 소개 → 다섯 음의 이름 →
  악보 읽기 → 박자와 리듬 → 첫 곡(젤다의 자장가) → 리듬 곡(사리아의 노래)
- 모든 단원이 **직접 연주해야 통과하는 실습**(음 내기·장음·순서 연주·듣고 따라하기·
  구절 연습·확인 퀴즈)으로 구성 — 배우면서 바로 연주합니다
- 오선보 그림·버튼 도해 포함, 단원별 진도 저장, 전 과정 수료 시 🎓 도전과제
