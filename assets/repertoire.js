...
(function () {
  ...
  const RSONGS = [
    ...
    {
      id: 'bongsunhwa', nameKo: '봉선화', name: 'Bongsunhwa — Hong Nan-pa', stars: 3, bpm: 80,
      key: 'A♭장조 (한 옥타브 위)',
      origin: '홍난파 작곡 (1920; 작곡가 1941년 작고) · 선율 저작권 만료 · 공개 악보의 한 절을 한 옥타브 위로 이조 · 가사 미수록',
      notes: [
        ['C5',.5],['C5',.5],['C5',.5],['F5',3],['G#5',.5],['G5',.5],['F5',.5],['G5',3],
        ['C5',.5],['C5',.5],['C5',.5],['C6',3],['G#5',.5],['G5',.5],['G#5',.5],['F5',3],
        ['G#5',.5],['G#5',.5],['G#5',.5],['C6',3],['C6',.5],['A#5',.5],['G#5',.5],['D#6',3],
        ['G#5',.5],['G5',.5],['F5',.5],['C6',3],['C6',.5],['F6',.5],['E6',.5],['F6',3],
        ['F6',.5],['D#6',.5],['C#6',.5],['C6',3],['C6',.5],['C#6',.5],['G#5',.5],['C6',3],
        ['C6',.5],['A#5',.5],['G#5',.5],['G5',3],['G#5',.5],['G5',.5],['E5',.5],['F5',3]
      ],
    },
    {
      id: 'seongbulsa-night', nameKo: '성불사의 밤', name: 'A Night at Seongbulsa — Hong Nan-pa', stars: 4, bpm: 76,
      key: 'A단조 (원보보다 한 옥타브 위)',
      origin: '홍난파 작곡 (1932; 작곡가 1941년 작고) · 선율 저작권 만료 · 공개 악보의 1절을 한 옥타브 위로 이조 · 가사 미수록',
      notes: [
        ['E5',.75],['E5',.25],['E5',2],['E5',1/3],['C5',1/3],['D5',1/3],
        ['E5',1],['E5',1],['E5',.75],['E5',.25],['F5',1.5],['A5',.5],['F5',.5],['D5',.5],
        ['E5',2],['E5',.75],['E5',.25],['A5',2],['B5',1/3],['A5',1/3],['B5',1/3],
        ['C6',1],['A5',1],['B5',.5],['B5',.5],['C6',.5],['B5',.5],['A5',.5],['A5',.5],['B5',1],
        ['E5',2],['E5',1],['A5',1.5],['E5',.5],['C5',.25],['C5',.25],['D5',.25],['D5',.25],
        ['E5',.5],['F5',.5],['E5',1],['E6',.5],['E6',.5],['E6',.5],['D6',.5],
        ['C6',1],['B5',1],['A5',3]
      ],
    },
    {
      id: 'land-of-hope', nameKo: '희망의 나라로', name: 'Land of Hope — Hyeon Je-myeong', stars: 4, bpm: 120,
      key: 'D장조 (한 옥타브 위)',
      origin: '현제명 작곡 (1933; 작곡가 1960년 작고) · 선율 저작권 만료 · 교육용 D장조 악보를 한 옥타브 위로 이조 · 가사 미수록',
      notes: [
        ['D6',1],['A5',1],['B5',.5],['C#6',.5],['D6',.5],['E6',.5],['D6',1],['B5',1],
        ['A5',.5],['B5',.5],['F#5',.5],['E5',.5],['D5',1.5],['E5',.5],['F#5',.5],['G5',.5],['A5',.5],['B5',.5],['E5',4],
        ['D6',1],['A5',1],['B5',.5],['C#6',.5],['D6',.5],['E6',.5],['D6',1],['B5',1],
        ['A5',.5],['B5',.5],['F#5',.5],['E5',.5],['D5',1.5],['E5',.5],['F#5',.5],['A5',.5],['G5',.5],['E5',.5],['D5',4],
        ['E5',1.5],['E5',.5],['A5',.25],['B5',.25],['A5',.25],['G5',.25],['F#5',.5],['D5',.5],
        ['F#5',.5],['A5',.5],['B5',.5],['D6',.5],['E6',1],['A5',1],['D6',1],['F#5',1],
        ['B5',1],['E5',1],['A5',.5],['D6',.5],['C#6',.5],['B5',.5],['A5',2],
        ['B5',1],['A5',1],['B5',.5],['C#6',.5],['D6',.5],['E6',.5],['D6',1],['B5',1],
        ['A5',.5],['B5',.5],['F#5',.5],['E5',.5],['D5',1.5],['E5',.5],['F#5',.5],['A5',.5],['G5',.5],['E5',.5],['D5',4]
      ],
    },
    {
    ...
    {
      id: 'caro', nameKo: '카로 미오 벤 (오! 내 사랑)', name: 'Caro mio ben — Giordani', stars: 3, bpm: 60, key: 'B♭장조 편곡',
  ...
  const repertoireIds = new Set(RSONGS.map((song) => song.id));
  const storedLearned = Array.isArray(storedRep) ? storedRep : [];
  let learned = new Set(storedLearned.filter((id) => repertoireIds.has(id)));
  if (learned.size !== storedLearned.length) writeLS('oot-rep', [...learned]);
  let playTimers = [];
